...
const PROJECTS = {
  ...
  ecoecho: {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/NavyashreeNS/ecoecho' }],
  },
  ...
  aitutor: {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/NavyashreeNS/ai-tutor' }],
  },
  ...
  appliedml: {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/NavyashreeNS/applied-ml-project-set' }],
  },
  ...
  rfid: {
    ...
    links: [
      { label: 'GitHub', href: 'https://github.com/NavyashreeNS/AI-RFID-Navigation-Assistant' },
    ],
  },
  ...
  ev: {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/NavyashreeNS/ev-efficiency-dc-generator' }],
  },
  ...
  petcare: {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/NavyashreeNS/your_first_kid' }],
  },
};
